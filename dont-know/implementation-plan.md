...
- [МЕХАНИКА-VALIDATION](dont-know/architecture.md#механика-validation-валидация-объявлений) — механическая валидация (стоп-слова, ценовая проверка оригинальности), ИИ-валидация через Gemini, три проверки MIN_VALIDATED_ITEMS
