...
- `MAX_CATALOG_WORKERS` - Максимум на парсинг каталогов (default: 3)
- `MAX_OBJECT_WORKERS` - Максимум на парсинг объявлений (default: 0)
- `TOTAL_VALIDATION_WORKERS` - Количество Validation Workers (default: 0)
...
Иметь больше одной страницы у воркера одновременноc